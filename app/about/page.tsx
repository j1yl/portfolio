  ...
  return (
    <>
      <section className="flex flex-col max-w-6xl w-full mx-auto md:px-8 px-2 h-[84vh] justify-center gap-10">
        <div>
          <h2 className="text-3xl md:text-[2rem] font-bold">ABOUT</h2>
        ...
        <div>
          <h2 className="text-3xl md:text-[2rem] font-bold">SKILLS</h2>
          <p className="text-base w-2/3">
        ...
        <div>
          <h2 className="text-3xl md:text-[2rem] font-bold">EXTRAS</h2>
          <p className="text-base w-2/3">
